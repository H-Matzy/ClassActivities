...
let incompleteUsers = data.filter(user => user.completed === false);
console.log(incompleteUsers);
// filter for user 6's tasks
let userSixTask = data.filter(user => user.userId === 6);
console.log(userSixTask);
// filter for tasks with a title less than 24 characters long
let lessThan24 = data.filter(user => user.title.length < 24);
