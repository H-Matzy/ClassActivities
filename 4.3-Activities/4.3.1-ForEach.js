...
let strings = [];
data.forEach(curr => {
  strings.push(curr.company.catchPhrase + ": " + curr.company.bs);
});
console.log(strings);
...
classes.forEach(
  (html, i) => (html.textContent = `Text content has changed, class: ${i}`)
);

//document.querySelectorAll(".class-week").forEach((ele, i) => {
//  ele.textContent = `This text has changed, class = ${i}`;
//});
